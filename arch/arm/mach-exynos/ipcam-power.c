...
static struct regulator_consumer_supply ldo17_supply[] = {
	REGULATOR_SUPPLY("vdd_3.3v_ap", NULL),
	REGULATOR_SUPPLY("ir_filter_3.3v", NULL),
};
...
static struct regulator_consumer_supply ldo23_supply[] = {
	...
	REGULATOR_SUPPLY("light_3.0v", NULL),
};
...
REGULATOR_INIT(ldo5, "VUSB_3.3V", 3300000, 3300000, 1,
...
REGULATOR_INIT(ldo12, "VUOTG_3.0V", 3000000, 3000000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
REGULATOR_INIT(ldo13, "VCC_1.8V_LCD", 1800000, 1800000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo14, "VABB2_1.95V", 1950000, 1950000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo17, "IR_FILTER_3.3V", 3300000, 3300000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo19, "VT_CAM_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo21, "VSD_2.8V", 2800000, 2800000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo23, "LIGHT_3.0V", 3000000, 3000000, 1,
	       REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_VOLTAGE, 1);
REGULATOR_INIT(ldo24, "VDD_1.8V_TSP", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo25, "VCI_3.0V_LCD", 3000000, 3000000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo26, "LED_3.3V", 3300000, 3300000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
