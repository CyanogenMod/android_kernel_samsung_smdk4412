...
static struct regulator_consumer_supply ldo5_supply[] = {
	...
	REGULATOR_SUPPLY("vsensor_1.8v", NULL),
#else
...
static struct regulator_consumer_supply ldo17_supply[] = {
	REGULATOR_SUPPLY("vsil_1.2v", NULL),
};
...
static struct regulator_consumer_supply ldo23_supply[] = {
		...
		defined(CONFIG_TARGET_TAB3_WIFI10) ||\
		defined(CONFIG_TARGET_TAB3_LTE10)
	REGULATOR_SUPPLY("vmot_3.3v", NULL),
#else
...
static struct regulator_consumer_supply ldo25_supply[] = {
		...
		defined(CONFIG_TARGET_TAB3_WIFI10) ||\
		defined(CONFIG_TARGET_TAB3_LTE10)
	REGULATOR_SUPPLY("tsp_avdd_2.8v_pm", NULL),
#else
...
REGULATOR_INIT(ldo3, "VCC_1.8V_AP", 1800000, 1800000, 1, 0, 0);
		...
		defined(CONFIG_TARGET_TAB3_WIFI10) ||\
		defined(CONFIG_TARGET_TAB3_LTE10)
REGULATOR_INIT(ldo5, "VSENSOR_1.8V", 1800000, 1800000, 1, 0, 0);
#else
REGULATOR_INIT(ldo5, "TSP_VDD_1.8V", 1800000, 1800000, 0,
...
REGULATOR_INIT(ldo12, "VUOTG_3.0V", 3000000, 3000000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
REGULATOR_INIT(ldo13, "VCC_1.8V_MHL", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo14, "VABB2_1.9V", 1950000, 1950000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo17, "VSIL_1.2V", 1200000, 1200000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo18, "CAM_IO_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo19, "VT_CORE_1.8V", 1500000, 1500000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo21, "VTF_2.8V", 2800000, 2800000, 0,
		...
		defined(CONFIG_TARGET_TAB3_WIFI10) ||\
		defined(CONFIG_TARGET_TAB3_LTE10)
REGULATOR_INIT(ldo23, "VMOT_3.3V", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#else
REGULATOR_INIT(ldo23, "LEDA_2.8V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#endif
REGULATOR_INIT(ldo24, "VDD_ADC_3.3V", 3300000, 3300000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
#if defined(CONFIG_TARGET_TAB3_3G10) ||\
		defined(CONFIG_TARGET_TAB3_WIFI10) ||\
		defined(CONFIG_TARGET_TAB3_LTE10)
REGULATOR_INIT(ldo25, "TSP_AVDD_2.8V_PM", 2800000, 2800000, 0,
		   REGULATOR_CHANGE_STATUS, 1);
#else
REGULATOR_INIT(ldo25, "TSP_VDD_3.3V", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#endif
REGULATOR_INIT(ldo26, "VCC_3.3V_MHL", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
...
static struct regulator_consumer_supply ldo22_supply[] = {
	REGULATOR_SUPPLY("5m_af_2.8v", NULL),
};
...
REGULATOR_INIT(ldo3, "VCC_1.8V_AP", 1800000, 1800000, 1, 0, 0);
REGULATOR_INIT(ldo5, "VCC_3.3V_MHL", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo8, "VMIPI_1.0V", 1000000, 1000000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo9, "VSIL_1.2V", 1200000, 1200000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo10, "VMIPI_1.8V", 1800000, 1800000, 1,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo13, "VCC_1.8V_MHL", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo19, "VLED_IC_1.9V", 1900000, 1900000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo20, "VTOUCH_3.3V", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo21, "TSP_VDD_3.3V", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo22, "5M_AF_2.8V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo23, "VTF_2.8V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo24, "LEDA_2.8V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo25, "TSP_VDD_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo26, "CAM_IO_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo27, "VTCAM_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
