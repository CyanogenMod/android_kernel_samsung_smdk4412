...
static struct regulator_consumer_supply s5m_ldo2_supply[] = {
...
#ifdef CONFIG_EXYNOS_C2C
static struct regulator_consumer_supply s5m_ldo6_supply[] = {};
#endif
...
#ifdef CONFIG_EXYNOS_C2C
S5M_REGULATOR_INIT(s5m_ldo2, "VM1M2_1.2V_AP", 1200000, 1200000, 1, 0, 0);
#endif
...
#endif
#ifdef CONFIG_EXYNOS_C2C
S5M_REGULATOR_INIT(s5m_ldo6, "VMPLL_1.0V_AP", 1100000, 1100000, 1, 0, 0);
#endif
...
#endif
#ifdef CONFIG_EXYNOS_C2C
	{S5M8767_LDO6, &s5m_ldo6_init_data,},
#endif
