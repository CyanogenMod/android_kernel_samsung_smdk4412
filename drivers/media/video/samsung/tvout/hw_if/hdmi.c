...
static u8 phy_config[][3][32] = {
	{/* freq = 25.200 MHz */
	...
	}, {/* freq = 27.027 MHz */
		{
		    ...
		    0x80, 0x80, 0x52, 0xd9, 0x45, 0xa0, 0xac, 0x80,
		    0x08, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xb6, 0x24, 0x00, 0x00, 0x94, 0x01, 0x80,
		}, {
	...
	}, {/* freq = 54 MHz */
		{
		    ...
		    0x08, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xe4, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd1, 0x38, 0x35, 0x53, 0x08, 0x04, 0x08,
		    0x88, 0xa0, 0x52, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0x08, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xb6, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd1, 0x22, 0x11, 0x61, 0x08, 0xfc, 0x08,
		    0x86, 0xa0, 0xcb, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0x08, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x98, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		},
	}, {/* freq = 54.054 MHz */
		{
		    ...
		    0x43, 0xa0, 0x0e, 0xd9, 0x45, 0xa0, 0xac, 0x80,
		    0x08, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xe3, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		}, {
	...
	}, {/* freq = 148.500 MHz  - Pre-emph + Higher Tx amp. */
		{
		    ...
		    0x81, 0xa0, 0xba, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0x3c, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x4b, 0x25, 0x03, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd1, 0x27, 0x01, 0x50, 0x40, 0xd6, 0x08,
		    0x81, 0xa0, 0xe8, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0xad, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x09, 0x25, 0x03, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd1, 0x2e, 0x02, 0x60, 0x40, 0x34, 0x08,
		    0x82, 0xa0, 0x16, 0xd9, 0x45, 0xa0, 0xac, 0x80,
		    0xad, 0x80, 0x11, 0x04, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xdd, 0x24, 0x03, 0x00, 0x94, 0x01, 0x80,
		},
	}, {/* freq = 148.352 MHz */
		{
	...
	}, {/* freq = 108.108 MHz */
		{
		    ...
		    0x54, 0xc7, 0x25, 0x03, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd2, 0x70, 0x14, 0x51, 0x50, 0x31, 0x08,
		    0x80, 0x80, 0x5e, 0xd9, 0x45, 0xa0, 0xac, 0x80,
		    0x5a, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x6c, 0x25, 0x03, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd4, 0x87, 0x01, 0x60, 0x64, 0x1b, 0x20,
		    0x19, 0xa0, 0xcb, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0x5a, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x2f, 0x25, 0x03, 0x00, 0x94, 0x01, 0x80,
		},
	}, {/* freq = 72 MHz */
		{
		    ...
		    0x5a, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xab, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0x52, 0x4b, 0x15, 0x51, 0x01, 0x00, 0x08,
		    0x82, 0x80, 0xe1, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0x5a, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x89, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		}, {
	...
	}, {/* freq = 65 MHz */
		{
		    ...
		    0x5a, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xbd, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd1, 0x22, 0x11, 0x51, 0x30, 0xf2, 0x08,
		    0x86, 0xa0, 0xcb, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0x5a, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x97, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd1, 0x29, 0x12, 0x61, 0x40, 0xd0, 0x08,
		    0x87, 0xa0, 0xf4, 0xd8, 0x45, 0xa0, 0xac, 0x80,
		    0x5a, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0x7e, 0x24, 0x01, 0x00, 0x94, 0x01, 0x80,
		},
	}, {/* freq = 108 MHz */
		{
	...
	}, {/* freq = 162 MHz */
		{
		    ...
		    0xad, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xf3, 0x24, 0x03, 0x00, 0x94, 0x01, 0x80,
		}, {
		    0x01, 0xd1, 0x33, 0x04, 0x60, 0x40, 0xd0, 0x08,
		    0x85, 0xa0, 0x32, 0xd9, 0x45, 0xa0, 0xac, 0x80,
		    0xad, 0x80, 0x11, 0x84, 0x02, 0x22, 0x44, 0x86,
		    0x54, 0xca, 0x24, 0x03, 0x00, 0x94, 0x01, 0x80,
		},
	},
};
#else
static const u8 phy_config[][3][32] = {
	{ /* freq = 25.200 MHz */
	...
	}, { /* freq = 27.027 MHz */
		{
			...
			0x6B, 0x10, 0x02, 0x51, 0xDf, 0xF2, 0x54, 0x87,
			0x84, 0x00, 0x30, 0x38, 0x00, 0x08, 0x10, 0xE0,
			0x22, 0x40, 0xe2, 0x26, 0x00, 0x94, 0x00, 0x80,
		}, {
	...
	}, { /* freq = 54.054 MHz */
		{
			...
			0x6B, 0x10, 0x01, 0x51, 0xDf, 0xF2, 0x54, 0x87,
			0x84, 0x00, 0x30, 0x38, 0x00, 0x08, 0x10, 0xE0,
			0x22, 0x40, 0xe2, 0x26, 0x01, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xd4, 0x10, 0x9C, 0x31, 0x50,
	...
	}, { /* freq = 148.500 MHz  - Pre-emph + Higher Tx amp. */
		{
			...
			0x84, 0x00, 0x10, 0x38, 0x00, 0x08, 0x10, 0xE0,
			0x22, 0x40, 0xa4, 0x26, 0x02, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x9C, 0xd6, 0x40,
			0x6B, 0x18, 0x00, 0x51, 0x7f, 0xF2, 0x54, 0xe8,
			0x84, 0x00, 0x10, 0x38, 0x00, 0xF8, 0x10, 0xE0,
			0x23, 0x41, 0x83, 0x26, 0x02, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x9C, 0x34, 0x40,
			0x6B, 0x18, 0x00, 0x51, 0xef, 0xF2, 0x54, 0x16,
			0x85, 0x00, 0x10, 0x38, 0x00, 0xE4, 0x10, 0xE0,
			0x23, 0x41, 0x6d, 0x26, 0x02, 0x94, 0x00, 0x80,
		},
	}, { /* freq = 148.352 MHz */
		{
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x9C, 0xef, 0x5B,
			...
			0x84, 0x00, 0x30, 0x38, 0x00, 0x08, 0x10, 0xE0,
			0x22, 0x40, 0xa5, 0x26, 0x02, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0x10, 0x10, 0x9C, 0xab, 0x5B,
			0x6F, 0x18, 0x00, 0x51, 0xbf, 0xF9, 0x54, 0xe8,
			0x84, 0x00, 0x32, 0x38, 0x00, 0xF8, 0x10, 0xE0,
			0x23, 0x41, 0x84, 0x26, 0x02, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD4, 0x10, 0x9C, 0xcd, 0x5B,
	...
	}, { /* freq = 108.108 MHz */
		{
			...
			0x84, 0x00, 0x30, 0x38, 0x00, 0x08, 0x10, 0xE0,
			0x22, 0x40, 0xe2, 0x26, 0x02, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD4, 0x10, 0x9C, 0x31, 0x50,
			0x6D, 0x18, 0x00, 0x51, 0x8f, 0xF3, 0x54, 0xa9,
			0x84, 0x00, 0x30, 0x38, 0x00, 0xF8, 0x10, 0xE0,
			0x22, 0x40, 0xb5, 0x26, 0x02, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0x10, 0x10, 0x9C, 0x1b, 0x64,
			0x6F, 0x18, 0x00, 0x51, 0x7f, 0xF8, 0x54, 0xcb,
			0x84, 0x00, 0x32, 0x38, 0x00, 0xE4, 0x10, 0xE0,
			0x22, 0x40, 0x97, 0x26, 0x02, 0x94, 0x00, 0x80,
		},
	}, { /* freq = 72 MHz */
		{
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x1C, 0x30, 0x40,
			...
			0x84, 0x00, 0x10, 0x38, 0x00, 0x08, 0x10, 0xE0,
			0x22, 0x40, 0xaa, 0x26, 0x01, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x1C, 0x30, 0x40,
			0x6F, 0x10, 0x01, 0x51, 0xBf, 0xF4, 0x54, 0xe1,
			0x84, 0x00, 0x30, 0x38, 0x00, 0xF8, 0x10, 0xE0,
			0x22, 0x40, 0x88, 0x26, 0x01, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x1C, 0x30, 0x40,
			0x6B, 0x18, 0x00, 0x51, 0xDf, 0xF2, 0x54, 0x87,
			0x84, 0x00, 0x30, 0x38, 0x00, 0xE4, 0x10, 0xE0,
			0x22, 0x40, 0xe3, 0x26, 0x02, 0x94, 0x00, 0x80,
		},
	}, { /* freq = 25 MHz */
		{
			...
			0x84, 0x00, 0x10, 0x38, 0x00, 0x08, 0x10, 0xE0,
			0x22, 0x40, 0xf5, 0x26, 0x00, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x9C, 0x08, 0x40,
			0x6B, 0x50, 0x10, 0x51, 0x7f, 0xF2, 0x54, 0xea,
			0x84, 0x00, 0x10, 0x38, 0x00, 0xB8, 0x10, 0xE0,
			0x22, 0x40, 0xc4, 0x26, 0x00, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x9C, 0x20, 0x40,
			0x6B, 0x10, 0x02, 0x51, 0xff, 0xF1, 0x54, 0xbc,
			0x84, 0x00, 0x10, 0x38, 0x00, 0xA4, 0x10, 0xE0,
			0x22, 0x40, 0xa3, 0x26, 0x00, 0x94, 0x00, 0x80,
		},
	}, { /* freq = 65 MHz */
		{
	...
	}, { /* freq = 162 MHz */
		{
			...
			0x84, 0x00, 0x10, 0x38, 0x00, 0xF8, 0x10, 0xE0,
			0x23, 0x41, 0x78, 0x26, 0x02, 0x94, 0x00, 0x80,
		}, {
			0x01, 0x05, 0x00, 0xD8, 0x10, 0x9C, 0xd0, 0x40,
			0x6B, 0x18, 0x00, 0x51, 0x3f, 0xF3, 0x54, 0x30,
			0x85, 0x00, 0x10, 0x38, 0x00, 0xE4, 0x10, 0xE0,
			0x23, 0x41, 0x64, 0x26, 0x02, 0x94, 0x00, 0x80,
		},
	},
};
#endif
...
static s32 s5p_hdmi_i2c_phy_interruptwait(void)
{
	...
	do {
		...
		retry_count++;
		if (retry_count > HDMI_I2C_PHY_WAIT_DELAY_COUNT) {
			tvout_err("timeout\n");
			return -1;
		}
		if (retry_count > HDMI_I2C_PHY_WAIT_COUNT)
			mdelay(1);
...
int s5p_hdmi_phy_disable_mode_set_done()
{
	u8 buff[2];
...
int s5p_hdmi_phy_enable_control(bool enable)
{
	if (enable) {
		if (!s5p_hdmi_phy_is_enable()) {
			...
			tvout_err("hdmi phy is aleady enabled.\n");
			return -1;
		}
	} else {
		if (s5p_hdmi_phy_is_enable())
			...
			tvout_err("hdmi phy is aleady disabled.\n");
			return -1;
		}
	}
	return 0;
...
{
	if (on) {
		writel(threshold, hdmi_base + S5P_HDMI_HPD_th_0);
		writeb(0x01, hdmi_base + S5P_HDMI_HPD_CTRL);
	} else {
		writeb(0x00, hdmi_base + S5P_HDMI_HPD_CTRL);
		writel(0x0, hdmi_base + S5P_HDMI_HPD_th_0);
	}
