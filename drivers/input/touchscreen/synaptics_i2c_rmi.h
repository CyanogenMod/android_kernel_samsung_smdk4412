...
#define SYNAPTICS_RMI4_DEVICE_CONTROL_FN (0x01)
#define SYNAPTICS_RMI4_F11_2D_SENSOR_FN (0x11)
#define SYNAPTICS_RMI4_F12_2D_SENSOR_FN (0x12)
#define SYNAPTICS_RMI4_0D_BUTTON_FN (0x1a)
#define SYNAPTICS_RMI4_FLASH_FN (0x34)
#define SYNAPTICS_RMI4_PROXIMITY_FN (0x51)
#define SYNAPTICS_RMI4_TEST_REPORTING_FN (0x54)
 ...
 * @index_to_intr_reg: index to associated interrupt register
 ...
 * @detection_work: work thread instance for expansion function detection
 * @detection_workqueue: pointer to work queue for work thread instance
 * @early_suspend: instance to support early suspend power management
 * @current_page: current page in sensor to acess
 * @button_0d_enabled: flag for 0d button support
 * @full_pm_cycle: flag for full power management cycle in early suspend stage
 * @number_of_interrupt_registers: number of interrupt registers
...
struct synaptics_rmi4_data {
	...
	unsigned short number_of_interrupt_registers;
