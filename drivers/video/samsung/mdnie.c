...
#ifdef CONFIG_FB_MDNIE_RGB_ADJUST
		if (wbuf[i] >= MDNIE_SCR_START && wbuf[i] <= MDNIE_SCR_END) {
			did_apply_rgb = true;
...
#ifdef CONFIG_FB_MDNIE_RGB_ADJUST
	__ATTR(r_adj, 0644, show_r_adj, store_r_adj),
	__ATTR(g_adj, 0644, show_g_adj, store_g_adj),	
	__ATTR(b_adj, 0644, show_b_adj, store_b_adj),
	__ATTR(rgb_adj_enable, 0644, show_rgb_adj_enable, store_rgb_adj_enable),
#endif
	__ATTR_NULL,
};
