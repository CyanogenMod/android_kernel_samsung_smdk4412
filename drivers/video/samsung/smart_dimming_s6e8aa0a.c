...
#include "smart_dimming_s6e8aa0a.h"
#ifdef CONFIG_S6E8AA0_AMS465XX
#include "s6e8aa0a_volt_tbl.h"
#else
...
/* SM2, Superior A1, A2 Ver A Panel */
static const u8 gamma_300cd_ver_a[] = {
...
const unsigned char gamma_id_list[GAMMA_300CD_MAX] = {
	0x23, 0x33, 0x43, 0x53, 0x63, 0x73, 0x83, 0x20, 0x2a, 0x29,
	0x40, 0x60, 0x4e, 0x8e, 0xae, 0x01, 0x02, 0xd2
};
