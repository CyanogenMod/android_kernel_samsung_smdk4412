...
enum v4l2_burst_proc_state {
	...
	V4L2_INT_STATE_BURST_PAUSE,
	V4L2_INT_STATE_BURST_RESUME,
};
...
/* FOR AF/AE Division Function in Galaxy-Camera M2 */
...
/* Enable/Disable the PF(Purple Fringe) */
#define V4L2_CID_CAMERA_CAC_EN	(V4L2_CID_PRIVATE_BASE+541)
...
#define V4L2_CID_CAMERA_SET_INTERLEAVED_MODE (V4L2_CID_PRIVATE_BASE + 542)
/* Getting EXIF from ISP */
#define V4L2_CID_CAMERA_EXIF			(V4L2_CID_PRIVATE_BASE +  543)
